...
{
    public class ArticleContent : AbstractParentContent<ArticleData>
    {
        public override void OnContentChanged()
        {
            base.OnContentChanged();

            var contentInChildren = Utilities.GetAllComponentsInChildren<ArticleContent, IContent>(transform);
        ...
        public override void OnImportData()
        {
            ...
            var contentElements = Utilities.GetAllComponentsInChildren<IContent, IContent>(transform);
